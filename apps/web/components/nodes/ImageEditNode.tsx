...
function ImageEditNodeComponent({ data }: { data: CanvasNode }) {
  return (
    <div className="w-[240px] rounded-[14px] border border-white/[0.05] bg-[#131415]/95 shadow-[0_8px_32px_rgba(0,0,0,0.35)] backdrop-blur-xl">
      ...
      <div className="flex items-center gap-2 border-b border-white/[0.04] px-3 py-2">
        <div className="flex h-6 w-6 items-center justify-center rounded-[8px] bg-[#1a1e14]">
          <Pencil className="h-3 w-3 text-[#a3d44e]" />
        </div>
        <span className="text-[11px] font-semibold uppercase tracking-[0.1em] text-[#a3d44e]">Edit</span>
      ...
      <div className="px-3 py-2">
        ...
        <div className="mt-0.5 text-[10px] text-[#5a6368]">Edited from original</div>
      </div>
      ...
      <div className="flex items-center gap-1 border-t border-white/[0.04] px-1.5 py-1.5">
        ...
        <button className="rounded-[8px] px-2.5 py-1 text-[10px] font-medium text-[#859399] transition hover:bg-white/[0.06] hover:text-[#a4e6ff]">Remix</button>
      </div>
    </div>
  );
}
